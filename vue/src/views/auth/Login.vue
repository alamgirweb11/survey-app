<template lang="">
      ...
      <form class="mt-8 space-y-6" @submit="login">
       ...
       <div v-if="inputErrors" class="py-3 px-5 bg-red-500 text-white rounded flex items-center justify-between">
       <p>{{ inputErrors.email[0] }}</p>
       <span @click="inputErrors = ''" class="w-8 h-8 flex items-center justify-center rounded-full transition-colors cursor-pointer hover:bg-[rgba(0,0,0,0.2)]">
       <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
       <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
      </svg>
       </span>
